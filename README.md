# GSPC board — snapshot as of 2026-09-13T06:03:55Z

**22 axes measured · 14 model fleets · 3 public leader scores · 8 fact runs · TIE is TIE · not a certificate.**

`GET https://councilof.ai/api/gspc` is the authority. This is a snapshot of that GET, read at `2026-09-13T08:15:52Z`, aligned to the transparency root `root.json` published at `2026-09-13T06:03:55Z`. If the live GET and these files disagree, the live GET wins. A fetch that fails is `UNCHECKABLE` — never a fabricated `0`.
...
- transparency root: `card_count` **264** signed cards, `merkle_root` `03d0ea31b374df4c3a7826ad4e6347a0c0baf75cad65d85a6f515427d504ea32`, `as_of` `2026-09-13T06:03:55Z`
...
| `root.json` | the transparency root, byte-for-byte (sha256 `f6c7d82651b30007c6c7c33d8ada7d0943610a11824e0893f4906b854fdb3e90`) |
...
Issuer: CSOAI Ltd (GB, Companies House 16939677). Board data licence as printed by the payload: `CC-BY-4.0`. Generated by `scripts/spray/gspc-spray.py (CSOAI-ORG/councilof-ai)`; fingerprint `b4875146626873f983382fb90333f6613ecb293b61716f4c3f8b11cc7fab3aff`.
